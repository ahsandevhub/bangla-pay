...
export const KYC_COPY: Record<Locale, KycCopy> = {
  bn: {
    ...
    errFields: "NID নম্বর ১০, ১৩ বা ১৭ সংখ্যার হতে হবে এবং কোনো ঘর ফাঁকা রাখা যাবে না।",
  ...
  en: {
    ...
    errFields: "The NID number must be 10, 13, or 17 digits and no field can be empty.",
